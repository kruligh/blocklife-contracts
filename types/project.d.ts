declare module 'project' {
  ...
  import {AnyContract, Contract, ContractBase, TransactionOptions, TransactionResult, TruffleArtifacts} from 'truffle';
  ...
  namespace project {
    ...
    // todo ts lint ignore
    interface GoldMine extends Mine {
    ...
    interface GoldMineContract extends Contract<GoldMine> {
